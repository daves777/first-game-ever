...
public class Game1StarWars3 extends JPanel implements ActionListener {
    ...
    public Game1StarWars3() {
        ...
        //Question 5 Label
        questionOne = new JLabel(" Who said this bounty hunter is my kind of scum: fearless and inventive");
        ...
        //Question 5 Buttons
        a1 = new JRadioButton("Greedo");
        b1 = new JRadioButton("Darth Vader");
        c1 = new JRadioButton("Han solo");
        d1 = new JRadioButton("Jabba the hutt");

        //Questions 5 Button Layout
        add(a1);
        /*
        ...
        //Question 6 Label
        questionTwo = new JLabel("What's the name of the famous sound effect that can be heard in every 'Star Wars' movie?");
        ...
        //Question 6 Buttons
        a2 = new JRadioButton("Castle Thunder");
        b2 = new JRadioButton("Tarzan Call");
        c2 = new JRadioButton("Wilhelm Scream");
        d2 = new JRadioButton("Laser Blast");

        //Question 6 Button Layout
        add(a2);
        /*
        Insert if statement for color depending on theme
         */
