...
public class Game3StarWars3 extends JPanel implements ActionListener {
    ...
    public Game3StarWars3() {
        ...
        //Question 5 Label
        questionOne = new JLabel("Han Solo’s trusty blaster is a:");
        ...
        //Question 5 Buttons
        a1 = new JRadioButton("DL-44");
        b1 = new JRadioButton("BB-88");
        c1 = new JRadioButton("D4-66");
        d1 = new JRadioButton("SK-32");
        ...
        //Question 6 Label
        questionTwo = new JLabel("How old is Yoda when he passes away?");
        ...
        //Question 6 Buttons
        a2 = new JRadioButton("300");
        b2 = new JRadioButton("500");
        c2 = new JRadioButton("750");
        d2 = new JRadioButton("900");
